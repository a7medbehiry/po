  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeCubit, HomeStates>(
      listener: (context, state) {
        if (state is SuccessAddLostPetState) {
          showToast(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('Pet Type', style: TextStyle(fontSize: 16)),
                        ...
                        SizedBox(height: 20),
                        Text('Last seen info', style: TextStyle(fontSize: 16)),
                        SizedBox(height: 10),
                        Container(
                          width: double.infinity,
                          height: 100,
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                ...
                                offset:
                                Offset(0, 0), // No offset to center the shadow
                              ),
                            ],
                          ),
                          child: Padding(
                        ...
                        Text('Gallery',
                            style:
                            TextStyle(fontSize: 16, fontFamily: 'PoppinsBold')),
                        SizedBox(height: 10),
                        ...
                        SizedBox(height: 40),
                        ConditionalBuilder(
                          condition: state is! LoadingAddLostPetState,
                          builder: (context) =>customButton(
                            ...
                            function: () {
                              ...
                              if(userToken!=''){
                                setState(() {
                                  isGalleryValid =
                                      galleryImages.isNotEmpty; // Validate the gallery
                                });
                                if (_formKey.currentState!.validate()) {
                                  _formKey.currentState!.save();
                                  HomeCubit.get(context).addLostPet(
                                    name: petName,
                                    age: age,
                                    type: type,
                                    gender: gender,
                                    breed: breed,
                                    lastseen_location: lastAddress,
                                    lastseen_time: time,
                                    lastseen_info: info,
                                  ...
                                  print("Form is not valid or currentState is null");
                                }
                              }else {
                                showDialog(
                                  context: context,
